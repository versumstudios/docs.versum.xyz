...
There are three types of verification Versum: unverified, off-chain, and on-chain verification. Users registered with any of the Tezos identity managers will be able to add multiple claims to their profile. The more claims you have, the higher your score. Above a certain score, you will unlock the **off-chain** status.
