...
If you have already received funds from sales on the secondary market and choose to get verified, we will soon be adding new functionality to withdraw your funds from escrow without having to wait for the two-week period to finish. Alternatively, click [here](https://better-call.dev/mainnet/KT1NUrzs7tiT4VbNPqeTxgAFa4SXeV1f3xe9/interact?entrypoint=withdraw_outstanding_tez) to manually withdraw your funds. Enter 0 as the amount. 
